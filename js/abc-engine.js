...
class AbcEngine {
  ...
  render(abcString) {
    ...
    try {
      ...
      // poder achicar la partitura un 40% hay que renderizar sin modo
      // responsive y dejar que scale controle el tamaño; `.score` tiene
      // overflow-x:auto por si el ancho fijo no cabe en pantallas angostas.
